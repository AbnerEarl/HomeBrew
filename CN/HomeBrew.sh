...
echo '
             ...
             \033[1;36m[ycj52011@outlook.com]\033[0m
           ['$TIME']['$macos_version']
       \033[1;36mhttps://blog.csdn.net/u014374009\033[0m
'
#选择一个下载源
echo '\033[1;32m
...
if [ $? -ne 0 ];then
    echo '
    \033[1;31m配置失败，请检查网络或者系统环境。\033[0m
    '
else
    echo "
        \033[1;32m如果提示Already up-to-date表示成功\033[0m
...
现在可以输入命令open ~/.zshrc -e 或者 open ~/.bash_profile -e 整理一下重复的语句(运行 echo \$SHELL 可以查看应该打开那一个文件修改)
        ...
        https://blog.csdn.net/u014374009  欢迎关注一起学习！\033[0m
    "
fi